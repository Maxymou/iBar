...
const { getAll, getOne, create, update, remove, getArchived, restore } = require('../controllers/restaurantController');
...
router.post('/', authenticate, upload.single('photo'), handleUploadError, validateMagicBytes, restaurantValidation, validate, create);
router.put('/:id', authenticate, upload.single('photo'), handleUploadError, validateMagicBytes, restaurantValidation, validate, update);
