...
router.post('/', authenticate, upload.single('photo'), handleUploadError, restaurantValidation, validate, create);
router.put('/:id', authenticate, upload.single('photo'), handleUploadError, restaurantValidation, validate, update);
